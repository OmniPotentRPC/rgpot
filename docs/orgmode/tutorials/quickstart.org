...
See the [[file:../howto/integration.org][integration guide]] for detailed namespace collision mitigation
...
- [[file:../howto/integration.org][Integration guide]] for embedding into external projects (e.g. eOn)
