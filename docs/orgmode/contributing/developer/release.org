...
We use [[https://towncrier.readthedocs.io][towncrier]] to manage release notes.
Each PR that affects users should include a /news fragment/ in the =docs/
...
Towncrier fragment checks are not yet wired into =prek.toml=; add a fragment
under =docs/newsfragments/= for user-facing changes and run =pixi r towncrier-draft=
...
The =rgpot-core= crate is published to [[https://crates.io/crates/rgpot-core]
[crates.io]].
Before publishing:
