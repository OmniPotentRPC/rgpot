...
TEST_CASE("CapnpAdapter: Position Conversion", "[rpc][adapter]") {
  ...
  auto convertedPos =
      rgpot::types::adapt::capnp::convertPositionsFromCapnp(reader, numAtoms);
...
TEST_CASE("CapnpAdapter: Box Matrix Conversion", "[rpc][adapter]") {
  ...
  auto reader = builder.asReader();
  auto convertedBox =
      rgpot::types::adapt::capnp::convertBoxMatrixFromCapnp(reader);
...
TEST_CASE("CapnpAdapter: Atom Types Conversion", "[rpc][adapter]") {
  ...
  auto reader = builder.asReader();
  auto converted =
      rgpot::types::adapt::capnp::convertAtomNumbersFromCapnp(reader);
